...
function Footer() {
  return (
    <footer className="px-6 py-10 text-gray-200 bg-[#454545]">
      <div className="grid max-w-6xl grid-cols-1 gap-y-8 mx-auto md:grid-cols-[1fr_auto_auto] md:gap-x-[60px]">


        {/* Cột 1 */}
        <div>
          <h2 className="mb-2 text-4xl font-bold">Hình ảnh của Đăng</h2>
          <p>
            Cổng thông tin điện tử về dân tộc và tôn giáo của Việt Nam dành cho người Việt Nam
          </p>
        </div>

        {/* Cột 2 */}
        <div>
          <h2 className="mb-2 text-4xl font-bold">Social</h2>
