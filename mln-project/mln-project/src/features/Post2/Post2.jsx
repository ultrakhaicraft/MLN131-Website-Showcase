...
import TonGiaoTrenMang from "@/assets/TonGiaoTrenMang.jpeg";
  ...
  return (
    <div className="min-h-screen bg-[#FAF7E6]">
      <div className="max-w-8xl mx-auto px-6 py-8 bg-[#FAF7E6]">
        ...
        <PostImage src={TonGiaoTrenMang} alt='Sử dụng không gian mang để làm hoạt động tôn giáo' 
                  imageCaption="Sử dụng không gian mang để làm hoạt động tôn giáo"/>
        ...
        <PostImage src={HinhAnhLeHoi} alt='Hình Ảnh lễ hội tôn giáo' 
                  imageCaption="Hình Ảnh lễ hội tôn giáo"/>
       ...
       <PostImage src={HinhAnhLeHoi1} alt='Nghi lễ tôn giáo tại chùa' 
                 imageCaption="Nghi lễ tôn giáo tại chùa"/>
