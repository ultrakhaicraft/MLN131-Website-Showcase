  ...
  return (
    <div className="min-h-screen bg-[#FAF7E6]">
      <div className="max-w-5xl mx-auto px-6 py-8 bg-[#FAF7E6]">
        ...
        <PostParagraph
          text="Có sự đa dạng, đan xen, là một phương tiện để chung sống hòa bình và không có xung đột, chiến tranh tôn giáo. Bởi vì nước Việt Nam có nhiều tôn giáo khác nhau, đều có nguồn gốc và quá trình phát triển khác nhau trong thời gian lịch sự nên sự gắn bó cũng khác nhau. Mọi người trong tôn giáo khi du nhập thường bản địa hóa, nghĩa là chung sống và hòa hợp với các tín đồ của tôn giáo khác trên một bàn địa. Luôn có một sự tôn trọng miền tin với nhau. Một ví dụ điển hình là Hồ Chi Minh có rất nhiều chùa cũng như là nhà thờ, với các người dân theo Phật và Công giáo sống cũng nhau."
          className="mb-4 font-semibold"
        />

        <PostParagraph
          text="Hầu như các tín đồ, người theo tôn giáo là nhân dân lao động, có lòng yêu nước, tinh thần dân tộc. Tín đồ có thành phần chủ yếu là người dân lao động, có tinh thần chống giặc, yêu nước, tôn trọng công lý, gắn bó với nhau và đi theo Đảng, hăng hái xây dựng bảo vệ Tổ Quốc. Trong lịch sử, nhiều nhân dân từ các tôn giáo khác nhau đã làm nên những thắng lợi to lớn, vẻ vang dân tộc"
          className="mb-4 font-semibold"
        />

        <PostParagraph
          text="Chủ tịch nước Nguyễn Xuân dã nêu rõ “lịch sử Việt Nam luôn ghi nhận những đóng góp to lớn của Đạo Phật đối với dân tộc, trong đó có sự nghiệp giải phóng dân tộc, thống nhất đất nước trước đây cũng như xây dựng, bảo vệ Tổ quốc ngày nay. Lấy phương châm “Phật pháp bất ly thế gian giác”, “hộ quốc, an dân” cho đường hướng hành đạo, Phật giáo luôn luôn là thành viên tin cậy, có nhiều đóng góp quan trọng trong khối đại đoàn kết toàn dân tộc.” Và Thủ tướng Nguyễn Xuân Phúc nói. “Các chuẩn mực đạo đức tích cực, nhân bản của tôn giáo đã dung nạp vào đời sống xã hội, góp phần tạo nên những chuẩn mực đạo đức, văn hóa ứng xử nhân văn, nhân ái của dân tộc ta, như Bác Hồ từng nói: “Chúa Giêsu dạy: Đạo đức là bác ái, Phật Thích Ca dạy: Đạo đức là từ bi, Khổng Tử dạy: Đạo đức là nhân nghĩa”, "
          className="mb-4 font-semibold"
        />
        ...
        <PostParagraph
          text="Chức sắc tôn giáo đóng vai trò quan trọng trong giáo hội, có uy tín, và ảnh hưởng tới người dân theo giáo (tín đồ), họ tự nguyện thực hiện thường xuyên nếp sống riêng theo giáo lý, giáo luật của tôn giáo mà họ tin theo. Họ là người truyền bá, thực hành giáo lý, giáo luật, lễ nghi, quản lý tổ chức của tôn giáo, họ có nhiệm vụ để duy trì, củng cố, và phát triển tôn giáo"
          className="mb-4 font-semibold"
        />

        <PostParagraph
          text="Các tôn giáo ở Việt Nam đều có quan hệ với các tổ chức, cá nhân tôn giáo ở nước ngoài. Đặc biệt, Nhà Nước Việt Nam đã thiết lập quan hệ ngoại giao với gần 200 quốc gia và vùng lãnh thổ trên toàn thế giới. Đại lễ Phật đản Vesak Liên hợp quốc 2008 được diễn ra tại Hà Nội đã chứng minh rằng Việt Nam là một nước muốn hòa bình, làm bạn với tất cả các nước trên thế  giới và tích cực góp phần xây dựng thế giới hòa bình."
          className="mb-4 font-semibold"
        />

        <PostParagraph
          text="Vì vậy, để giải quyết các vấn đề tôn giáo ở Việt Nam thì nên mở rộng giao lưu hợp tác quốc tế với việc bảo đảm độc lập, chủ quyền, không cho ai lợi dụng để âm mưu “diễn biến hòa bình” đối với nước ta"
          className="mb-4 font-semibold"
        />
        ...
        <PostParagraph
          text="Tôn giáo là hiện tượng xã hội có nguồn gốc phức hợp — tự nhiên, kinh tế-xã hội, nhận thức và tâm lý. Trong thời kỳ quá độ lên chủ nghĩa xã hội, chủ nghĩa Mác–Lênin cung cấp phương pháp luận khoa học để hiểu và xử lý vấn đề tôn giáo: không theo đuổi đàn áp, mà phải kết hợp tôn trọng quyền tự do tín ngưỡng với biện pháp xã hội-kinh tế, giáo dục và quản lý nhằm khắc phục nguyên nhân sinh ra ảo tưởng tôn giáo và ngăn chặn hành vi lợi dụng tôn giáo gây phương hại xã hội. Ở Việt Nam, với đặc thù đa tôn giáo, chính sách nhất quán là bảo đảm quyền tự do tín ngưỡng, phát huy giá trị tích cực của tôn giáo và kiên quyết phòng chống, xử lý hành vi lợi dụng tôn giáo để phá hoại khối đại đoàn kết và an ninh quốc gia."
          className="mb-4 font-semibold"
        />
...
<div className="mt-8">
  ...
  <ul className="pl-6 mt-2 space-y-2 text-blue-600 list-disc">
    <li>
      <a
        href="https://baochinhphu.vn/dong-bao-cac-ton-giao-la-mot-bo-phan-cua-khoi-dai-doan-ket-toan-dan-toc-102303516.htm"
        target="_blank"
        rel="noopener noreferrer"
      >
        Đồng bào các tôn giáo là một bộ phận của khối đại đoàn kết toàn dân tộc — Báo Chính Phủ
      </a>
    </li>
    <li>
      <a
        href="https://thanhnien.vn/tin-do-cac-ton-giao-deu-co-tinh-than-yeu-nuoc-185873928.htm"
        target="_blank"
        rel="noopener noreferrer"
      >
        Tín đồ các tôn giáo đều có tinh thần yêu nước — Báo Thanh Niên
      </a>
    </li>
    <li>
      <a
        href="https://vietnam.opendevelopmentmekong.net/topics/overview-of-religions-in-vietnam/"
        target="_blank"
        rel="noopener noreferrer"
      >
        Overview of Religions in Vietnam — Open Development Mekong
      </a>
    </li>
    <li>
      Dương, X. N., Đỗ, T. T., & Hoàng, C. B. (2021). 
      <i> Giáo trình Chủ nghĩa xã hội khoa học.</i> 
